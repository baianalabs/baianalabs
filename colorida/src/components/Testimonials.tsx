...
const testimonials = [
  {
    name: "Mitchel Mendes",
    role: "CTO Techflow",
    content: "Supera tranquilamente sistemas líderes do mercado que custam 10x mais para operar.",
    rating: 5,
  ...
  },
  {
    name: "Marcus Cseko",
    role: "CEO TechFlow",
    content: "A automação com IA transformou completamente nosso processo de qualificação de leads. Impressionante!",
    rating: 5,
    avatar: marcusAvatar
  },
  {
  ...
  return (
    <section className="py-40 px-8 max-w-7xl mx-auto relative">
      ...
      <div className="text-center mb-24">
        ...
        >
          Nossos <span className="text-gradient-logo">Clientes Satisfeitos</span>
        </motion.h2>
      </div>
