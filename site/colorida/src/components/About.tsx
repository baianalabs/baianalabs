      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        <div className="space-y-10">
          ...
          >
            ...
            <p>
              De um lado, anos respirando tecnologia e enxergando possibilidades onde outros veem limites. 
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-primary/10 to-secondary/10 opacity-0 group-hover:opacity-100 transition-opacity rounded-3xl" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {pillars.map((pillar, i) => (
              <motion.div
                ...
                className="glass-card p-6 rounded-3xl border-white/5 hover:border-primary/30 transition-all hover:-translate-y-2 group overflow-hidden"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                <div className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center text-primary mb-4 group-hover:scale-110 transition-transform relative z-10">
                  <pillar.icon className="w-5 h-5" />
                </div>
                <h4 className="text-white font-bold mb-2 uppercase tracking-tighter text-sm relative z-10">{pillar.title}</h4>
                <p className="text-xs text-white/50 leading-tight relative z-10">{pillar.desc}</p>
              </motion.div>
            ))}
          </div>
